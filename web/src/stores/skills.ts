...
export const useSkillsStore = defineStore('skills', {
  state: () => ({
    ...
    currentView: 'list' as 'list' | 'detail' | 'editor' | 'manage' | 'toggle' | 'manager' | 'prompt' | 'promptMaintenance' | 'agent' | 'apiTester' | 'llmCallLogs' | 'imageHistory',
  ...
  actions: {
    ...
    setView(v: 'list' | 'detail' | 'editor' | 'manage' | 'toggle' | 'manager' | 'prompt' | 'promptMaintenance' | 'agent' | 'apiTester' | 'llmCallLogs' | 'imageHistory') { this.currentView = v },

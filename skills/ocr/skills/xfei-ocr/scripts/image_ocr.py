...
"""
Xfei LLM OCR Client
OCR images using Xfei LLM OCR API (HMAC-SHA256 authentication)
"""
...
class XfeiImageOCRClient:
    """Client for Xfei LLM OCR service."""
...
def main():
    parser = argparse.ArgumentParser(
        description="OCR images using Xfei LLM OCR API"
    )
    ...
    try:
        # Create client
        client = XfeiImageOCRClient(app_id, api_key, api_secret)

...
export const useSkillsStore = defineStore('skills', {
  state: () => ({
    ...
    currentView: 'list' as 'list' | 'detail' | 'editor' | 'manage' | 'toggle' | 'manager' | 'prompt' | 'promptMaintenance' | 'agent',
  ...
  actions: {
    ...
    setView(v: 'list' | 'detail' | 'editor' | 'manage' | 'toggle' | 'manager' | 'prompt' | 'promptMaintenance' | 'agent') { this.currentView = v },

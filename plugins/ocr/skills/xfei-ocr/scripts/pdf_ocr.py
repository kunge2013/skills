...
"""
Xfei PDF OCR Client
Recognize PDF documents using Xfei PDF OCR API (MD5 + HMAC-SHA1 authentication)
"""
...
class XfeiPdfOCRClient:
    """Client for Xfei PDF OCR service."""
...
def main():
    parser = argparse.ArgumentParser(
        description="OCR PDF documents using Xfei PDF OCR API"
    )
    ...
    # Create client
    client = XfeiPdfOCRClient(app_id, api_secret)
